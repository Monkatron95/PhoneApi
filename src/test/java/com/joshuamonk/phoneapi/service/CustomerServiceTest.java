...
public class CustomerServiceTest {
    ...
    public void setup() {
        ...
        // Global setup for mocking numbers
    ...
    public void activateCustomerPhoneNumber() {
        when(customerRepo.addCustomerPhoneNumber(1L, "01234567890"))
                .thenReturn(Optional.of(new Customer(1L, "Ben", "Bobby", "8 Bob Lane",
    ...
    public void activateCustomerPhoneNumberCustomerNotFound() {
        when(customerRepo.addCustomerPhoneNumber(1L, "019857648765")).thenReturn(Optional.empty());

        Customer result = customerService.activateCustomerPhoneNumber(1L, "019857648765");
    }

    @Test(expected = InvalidPhoneNumberExeception.class)
    public void activateCustomerPhoneNumberInvalidPhoneNumber() {
        Customer result = customerService.activateCustomerPhoneNumber(1L, "");
    }

    @Test(expected = PhoneNumberInUseException.class)
    public void activateCustomerPhoneNumberPhoneNumberInUse() {
        Customer result = customerService.activateCustomerPhoneNumber(1L, "07876765409");
    }
}
