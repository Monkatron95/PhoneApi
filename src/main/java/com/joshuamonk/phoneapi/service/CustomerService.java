...
import com.joshuamonk.phoneapi.exception.NumberInUseException;
...
public class CustomerService {
     ...
     * @throws NumberInUseException when the given number is already activated for another customer
     */
    public Customer activateCustomerPhoneNumber(long id, String number) throws CustomerNotFoundException,
            InvalidPhoneNumberExeception, NumberInUseException {
        ...
        if (currentNumbers.contains(number)) {
            throw new NumberInUseException("This phone number is already in use");
        }
